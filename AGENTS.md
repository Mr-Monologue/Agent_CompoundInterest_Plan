...
- 最近阶段的授权原文、四项范围、完成标准与外部依赖见 `docs/LAUNCH_CHECKLIST.md` 的“2026-09-24 阶段持续部署授权”。该限定阶段已随 v0.37.3 最终验收结项，持续部署授权已终止；下一阶段提案尚未授权。新会话先读清单最终结项与 `docs/STAGE_CLOSEOUT.md`，不得沿用已结束阶段授权。今后阶段交付完成、撤回或实质扩大范围时同样终止，不自动扩展。
