...
def test_phase1_mcp_exposes_guarded_ledger_tools() -> None:
    ...
    assert [tool.name for tool in tools] == [
        ...
        "review_trend_snapshot_build",
        "review_trend_snapshot_list",
        "review_quality_snapshot_build",
        "review_quality_snapshot_list",
        "market_research_evidence_record",
        "research_source_contract_get",
        "research_source_config_draft_create",
        "research_source_config_draft_get",
        "research_source_config_draft_commit",
        "research_source_config_list",
        "research_collection_run_record",
        "research_collection_run_list",
        "research_coverage_snapshot_build",
        "research_coverage_snapshot_list",
        "research_collection_task_claim",
        "research_collection_task_complete",
        "research_collection_task_list",
        "research_collection_task_claim_list",
        "research_connector_health_record",
        "research_connector_health_list",
        "research_coverage_change_list",
        "market_research_evidence_list",
        "market_research_evidence_change_list",
        "market_discovery_scan",
        "market_discovery_run_list",
        "market_discovery_change_list",
        "research_watchlist_transition_draft_create",
        "research_watchlist_transition_draft_commit",
        "research_watchlist_list",
        "research_watchlist_review_snapshot_build",
        "research_watchlist_review_snapshot_list",
        "review_action_decision_draft_create",
        "review_action_decision_draft_commit",
        "review_action_outcome_draft_create",
        "review_action_outcome_draft_commit",
        "review_action_outcome_list",
        "cash_event_draft_create",
        "cash_event_draft_commit",
        "cash_ledger_event_list",
        "official_nav_backfill_record",
        "official_nav_backfill_list",
        "runtime_mode_get",
        ...
        "strategy_instrument_config_draft_commit",
        ...
        "valuation_observation_record",
        "valuation_snapshot_get",
        "satellite_signal_policy_draft_create",
        "satellite_signal_policy_draft_get",
        "satellite_signal_policy_draft_commit",
        "satellite_signal_policy_list",
        "satellite_signal_snapshot_build",
        "satellite_signal_snapshot_list",
        "risk_scan_run",
        "risk_rule_hit_list",
        "lifecycle_observation_record",
        "lifecycle_observation_list",
        "sell_proposal_list",
        "sell_proposal_context_get",
        "sell_decision_draft_create",
